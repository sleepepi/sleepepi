...
==== Download and Install LaTeX (CentOS 5/6)
  ...
  sudo yum install tetex tetex-fonts tetex-dvips tetex-latex ghostscript
...
=== 820 WKHTMLTOPDF
  ...
  NOTE: Required for CHAT Publications and Slice (will be removed as a dependency though)

Download an install wkhtmltopdf
...
NOTE: Later versions (0.11.0) may install but silently fail when rendering PDFs
