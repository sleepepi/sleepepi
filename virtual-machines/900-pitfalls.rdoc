...
You can do a secure copy to copy files from <b>epipro01.dipr.partners.org</b>, make sure you change <i>notes</i> to the correct rails application!

  scp username@epipro01.dipr.partners.org:/usr/local/production/<i>notes</i>/config/initializers/devise.rb /usr/local/production/<i>notes</i>/config/intializers/devise.rb
  scp username@epipro01.dipr.partners.org:/usr/local/production/<i>notes</i>/config/initializers/omniauth.rb /usr/local/production/<i>notes</i>/config/intializers/omniauth.rb
  scp username@epipro01.dipr.partners.org:/usr/local/production/<i>notes</i>/config/initializers/secret_token.rb /usr/local/production/<i>notes</i>/config/intializers/secret_token.rb
