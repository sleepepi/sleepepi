...
Note: If you can't mount you may need to install <tt>cifs-utils</tt>, see {Pitfall 970}[https://github.com/sleepepi/sleepepi/blob/master/virtual-machines/900-pitfalls.rdoc#970-fstab-file-mount-not-working]
