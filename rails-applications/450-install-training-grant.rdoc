...
NOTE: If you get <tt>fatal: could not create work tree dir 'training_grant'.: Permission denied</tt> that means you forgot to run:
...
NOTE: If you get <tt>Do you wish to trust this .rvmrc file? (/usr/local/production/training_grant/.rvmrc)</tt> then type <tt>yes</tt>
...
NOTE: The contents of the following files will need to be copied from *epipro01* since they are not in version control and contain pseudo-randomly generated strings
  ...
  scp username@epipro01.dipr.partners.org:/usr/local/production/training_grant/config/initializers/devise.rb /usr/local/production/training_grant/config/intializers/devise.rb
  scp username@epipro01.dipr.partners.org:/usr/local/production/training_grant/config/initializers/omniauth.rb /usr/local/production/training_grant/config/intializers/omniauth.rb
  scp username@epipro01.dipr.partners.org:/usr/local/production/training_grant/config/initializers/secret_token.rb /usr/local/production/training_grant/config/intializers/secret_token.rb
...
This loads the RFA space <tt>/projects/informatics/training_grant/uploads</tt>
...
=== 456 Update to Latest Stable version of Training Grant
